INSERT INTO `with total_revenue_table as (select case when date_format (o.date, "%M") = 'January' or date_format (o.date, "%M") = 'February' or date_format (o.date, "%M") = 'March' then "1st quarter"
...
select month, round(sum(order_total_price),1) as total_revenue from total_revenue_table group by 1` (`month`,total_revenue) VALUES
	 ('1st quarter',205350.0),
	 ('2nd quarter',208369.8),
	 ('3rd quarter',205016.2),
	 ('4th quarter',199124.1);
